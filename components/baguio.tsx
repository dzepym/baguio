  ...
  const itinerary = [
    {
      ...
      activities: [
        { time: "7:00 AM", activity: "Early hotel check-in & leave luggage", icon: "🏨" },
        { time: "8:00 AM", activity: "Baguio Cathedral", icon: "⛪" },
        { time: "9:00 AM", activity: "Foam Coffee near Session Road", icon: "☕" },
        { time: "10:00 AM", activity: "Walk along Session Road", icon: "🚶" },
    ...
    },
    {
      ...
      activities: [
        { time: "5:00 AM", activity: "Morning jog around Burnham Park", icon: "🏃" },
      ...
      <main className="max-w-6xl mx-auto px-6 md:px-8 pb-20 relative z-10">
        ...
        <div className="mb-8 text-center animate-bounce-in">
          ...
          <div className="flex items-center justify-center gap-6 mt-6">
            <button
              onClick={prevSlide}
              className="flex items-center gap-2 px-6 py-3 bg-blue-300 hover:bg-blue-400 rounded-full border-4 border-gray-800 font-black transition-all duration-300 hover:scale-105 shadow-lg text-black"
            ...
            <button
              onClick={nextSlide}
              className="flex items-center gap-2 px-6 py-3 bg-pink-300 hover:bg-pink-400 rounded-full border-4 border-gray-800 font-black transition-all duration-300 hover:scale-105 shadow-lg text-black"
              style={{ boxShadow: '4px 4px 0px rgba(0,0,0,0.2)' }}
            >
              <span>Next</span>
