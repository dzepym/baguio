...
export default function ItineraryPresentation() {
  ...
  const itinerary = [
    ...
    },
    {
      ...
      activities: [
                   { time: "6:00 AM", activity: "Secret Garden at Camp John Hay" , icon: "🌿" },
            { time: "7:00 AM", activity: "Bell Amphitheater and Cemetery of Negativism", icon: "🏛️" },  
                     { time: "8:00 AM", activity: "Breakfast at Choco-late de Batirol", icon: "🍫" },                
       ...
       { time: "1:00 PM", activity: "La Trinidad Strawberry Farm", icon: "🍓" },
        { time: "2:00 PM", activity: "Bell Church", icon: "💒" },
        { time: "3:00 PM", activity: "Valley of Colors", icon: "🎨" },       
        { time: "4:00 PM", activity: "Dragon Castle", icon: "🐉" },
        { time: "6:00 PM", activity: "SM Baguio", icon: "🏬" },
        { time: "8:00 PM", activity: "Bowling", icon: "🎳" },
      ],
      images: [
